let receiptItems = [];
const shopName = "Laxmi Decorators"; // Replace 'Your Shop Name' with your shop's name
...
function generatePDF() {
  ...
  </style></head><body><div>${image} ${shopHeader}</div>${shopDetails} ${dateDiv} ${itemsTable} ${customerDetails}</body></html>`;
